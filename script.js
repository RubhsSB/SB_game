...
const wordsCustom = [
  "CyC (Host cambio posición)", "Daniel y Alma", "MARCO ESPEJO", "CyC (lanzo atrás en 3)", "JHERSY (Preparar pos Cerrada)", "ALBERTO y MARÍA (Cats - Giro espalda)", "JHERSY (Preparo sensual + mano Follow)", "JHERSY (preparo sensual + lanzo en 4 y salgo)", "K_ELDE Intro", "K_ELDE (mano en 5)", 
