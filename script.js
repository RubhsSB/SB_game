...
"CyC (Host cambio posición)", "Daniel y Alma", "CyC (Host círculo Dcha)", "CyT Sensual", "JyE (diagonal Cintura)", "EyG (abro y cierro)", "DyY (abro en 4)", "MARCO ESPEJO", "CyC (lanzo atrás en 3)", "JHERSY - Molino",
 ...
 "70'", "Yowke", "Pasitos Elw Adelante/Atrás", "Pasitos Elw Izq/Dcha", "Cambio posición con mano Izq (Marc/Sra)", "FRANCIA", "Alex y Lais (jóvenes -3+1)", "VyA (Cambio mano + Freno en 6)", "DyY (Separo en 4 y al hombro - SanSebastián)", 
 ...
 "CyC Freno en 2 y alargo 3-4", "GOLPE Elw", "JyE Diagonal + Giro", "INTRO", "EyG (Lanzo y Diagonal)", "VALENT", "VyA (Freno hombro en 2)", "FLECHA", "CyC (Giro en Diagonal + abrazo cuellos)", "CyC (Olas Izq + Molino Follow)", 
 "CyC (Giro en diagonal)", "CyC (Diagonal + paseo)", "GERO y MIGLE (cambio pos 360º)", "Cuello (en 6)", "CyT (3 giros con Cuello)", "EyG (Rompo y abajo - SanSebastián)", "BRAZOS frame", "JOVENES 70'+ Cuello", "5 cintura abajo", 
 ...
 "IVAN Y SARAI (3 sensual + Cadera)", "Diagonal JHersey", "Diagonal JHersey", "CyC (Giro en Diagonal + abrazo cuello)", "EyG (5 gira Foll + 7 gira Led)", "EyG (!72 Sensual + disoc Follo)", "Básico (Grande + Pequeño)", "Básico (Grande + Pequeño)"
];
const wordsCustom = [
 ...
 "JHERSY pasos", "JHERSY (Giro cambio mano)", "JHERSY (salir/end)", "Cambio posición con mano Izq (Marc/Sra)", "FRANCIA", "Alex y Lais (jóvenes -3+1)", "DyY (Separo en 4 y al hombro - SanSebastián)", "JyE (preparo salida en 8)", 
 ...
 "SINCOPADO", "Pasos CARLOS", "STEPHAN y NEVI (freno en 3 y horiz)", "CyC (Diagonal + paseo)", "Diagonal JHersey", "CyT (Tumbar Follow)", "DyY (Cats Giro en 5 + Brazos)", "IVAN Y SARAI (3 sensual + Cadera)", "EyG (!72 Sensual + disoc Follo)", 
 "Básico (Grande + Pequeño)"
];
