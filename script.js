...
"CyC (Host cambio posición)", "Daniel y Alma", "CyC (Host círculo Dcha)", "CyT (Sensual)", "JyE (diagonal Cintura)", "EyG (abro y cierro)", "DyY (abro en 4)", "MARCO ESPEJO", "CyC (lanzo atrás en 3)", "JHERSY (Molino)",
 ...
 "EyG (Cambio posición + Giro + Peino + Giro + ONDA abajo)",  "VyA (Segovia - 2 Preparo y abro + 4 Giro Follow)", "CyC (Segovia - ½ Diagonal + Preparo en 6)", "DyY (Segovia - Lanzo + peino + sombra)", 
...
"CyC (Host cambio posición)", "Daniel y Alma", "JyE (diagonal Cintura)", "EyG (abro y cierro)", "DyY (abro en 4)", "MARCO ESPEJO", "CyC (lanzo atrás en 3)","JHERSY (Preparar pos Cerrada)", "SERGIO y KATINA (Círculo y tiro atrás - Bassmnt)",
 "EyG (Cats giro 2 manos)", "ALBERTO y MARÍA (Giro espalda-Cats)", "JHERSY (preparo sensual + mano Follow)", "JHERSY (preparo sensual + lanzo en 4 y salgo)", "GtoyM", "K_ELDE Intro", "K_ELDE (mano en 5)", "JLAB (salir/end)", "IVAN y SARAI (Cuadrado Host)",
 ...
 "Alex y Lais (jóvenes -3+1)", "DyY (SanSebastián - Separo en 4 y al hombro)", "JyE (preparo salida en 8)", "CyC (Mambo Manos Hombro)", "70'", "DyY (Bajo cabeza - Cats)", "DyY (Giro mano escápula - Bassment)", "ENGAÑO", 
 ...
 "Cuellar Bachatero (Giro + Camb Pos + Sombra + peino)", "CyC (Host - Peino Follow + Me peino)", "Giros", "Giros", "CyC (Giro en Diagonal + abrazo cuello)", "SERGIO y KATINA (molino en 1 Casa Campo)", "DyY (Arriba para Diagonal + Contra en 5)", 
